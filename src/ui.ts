...
export interface DiffViewerOptions {
    ...
    theme: DocumentTheme;
    onClose: () => void;
    /** Defaults to pi's `renderDiff`, which uses pi's active theme. */
    renderDiffText?: DiffTextRenderer;
}
...
export class DiffViewer implements Component {
    ...
    private readonly theme: DocumentTheme;
    private readonly renderDiffText: DiffTextRenderer;
    ...
    constructor(options: DiffViewerOptions) {
        ...
        this.renderDiffText = options.renderDiffText ?? renderDiff;
    ...
    private rebuild(): void {
        ...
        this.sectionStarts = document.sectionStarts;
    }
